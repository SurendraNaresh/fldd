...
class _HomePageState extends State<HomePage> {
  ...
  void initGame() {
    ...
    items = [
       ...
       ItemModel(icon: Icons.snapchat, name: 'Snapchat', value: "snapchat"),
      ...
      ItemModel(icon: Icons.computer, name: 'Linux', value: "linux"),
       ItemModel(icon: Icons.airlines, name: 'Windows', value: "windows"),
    ];
    items.shuffle();
            ...
            Flexible(
              child: GridView.builder(
                ...
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio: 2.6, // Control height/width ratio
                ),
                  ...
                  return Container(
                    ...
                    decoration: const BoxDecoration(
                      border: Border(
                        ...
                        //bottom: BorderSide(width: 2, color: Colors.greenAccent), // Bottom border (grid line)
                      ),
                    ),
